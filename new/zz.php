...
<head>
    ...
    <script type="text/javascript" src="/misc/js/prototype.js"></script>
    <!--Use google lib for jquery -->
    <script type="text/javascript" src="/misc/js/jquery.min.js"></script>
    <script type="text/javascript" src="/misc/js/nwsexit-spc.js"></script>
    <!--SPCindex.js is used to update page content -->
    <script type="text/javascript" src="/new/js/SPCindex-new.js"></script>
    <!--jquery.csv -->
    <script type="text/javascript" src="/new/js/jquery.csv.min.js"></script>
...
var tabberOptions = { 
  ...
  'onClick': function(argsObj) {
    ...
    */
    var url = '/new/SPCProducts/validProducts-'+i+'.html';
