...
<head>
    ...
    <script async src="//ajax.googleapis.com/ajax/libs/prototype/1.7.1.0/prototype.js"></script>
    ...
    <script async type="text/javascript" src="/new/js/SPCindex.js"></script>
    <!--usno_gmttime.js used to run UTC clock at the top of the page -->
    <script async type="text/javascript" src="/misc/usno_gmttime.js"></script>
    <!--lastMod.js used for page update time in the footer -->
    <script async type="text/javascript" src="/misc/lastMod.js"></script>
    <!--hoverIntent.minified.js used for main menu functionality -->    
    <script async type="text/javascript" src="/new/js/jquery.hoverIntent.minified.js"></script>
    <!--flot.js and flot.time.min.js used for plotting severe reports -->
    <script async language="javascript" type="text/javascript" src="/new/js/jquery.flot.js"></script>
    <script async language="javascript" type="text/javascript" src="/new/js/jquery.flot.time.min.js"></script>
    <!--jquery.cycle.all.js used to cycle through forecast tools in PanelContent -->
    <script async language="javascript" type="text/javascript" src="/new/js/jquery.cycle.all.js"></script>	
...
<script async type="text/javascript" src="/new/js/topNavMenu.js"></script>
...
<script async type="text/javascript" src="/new/js/tabber.js"></script>
...
<div>
  <?php include($_SERVER['DOCUMENT_ROOT']."/new/PanelContent/panelContentSM.php"); ?>
   ...
   <div class="footer_container">
	...
	<?php
	 $filename = $_SERVER['DOCUMENT_ROOT'].'/new/SPCWeatherHeadlines/headlines-zz.html';
