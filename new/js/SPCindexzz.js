...
function updateProducts() {
	var $j = jQuery.noConflict();
	$j.ajax({
		url: "/new/SPCProducts/validProductszz.php?content=0",
	...
	$j.ajax({
                url: "/new/SPCProducts/validProductszz.php?content=1",
                success: function(data) {
                        var $j = jQuery.noConflict();
                        $j("#allWW").html(data);
                        }
	...
	$j.ajax({
                url: "/new/SPCProducts/validProductszz.php?content=2",
                success: function(data) {
                        var $j = jQuery.noConflict();
                        $j("#allMD").html(data);
                        }
	...
	$j.ajax({
                url: "/new/SPCProducts/validProductszz.php?content=3",
                success: function(data) {
                        var $j = jQuery.noConflict();
			var d = new Date();
                        $j("#allOTLK").html(data);
	...
	$j.ajax({
                url: "/new/SPCProducts/validProductszz.php?content=4",
                success: function(data) {
                        var $j = jQuery.noConflict();
			var d = new Date();
                        $j("#allFIRE").html(data);
