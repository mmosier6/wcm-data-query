...
$prodFile = file("../SPCProducts/validProducts.txt");
...
$tornfile = file("../../climo/reports/${rptDate}_rpts_torn.csv");
$windfile = file("../../climo/reports/${rptDate}_rpts_wind.csv");
$hailfile = file("../../climo/reports/${rptDate}_rpts_hail.csv");
...
if (($tornSize == 0) && ($windSize == 0) && ($hailSize == 0)) {
	...
	print "<td valign='top' width='33%' id='TopicContainer'>\n";
        ...
        include("../SVRclimo/climoSlides.php"); 
        print "</td></tr>\n";
	...
	print "<td valign='top' width='33%' id='TopicContainer'>\n";
        ...
        print "<tr><td align='center'><a href='/exper/situation/?lat=32.00&lon=-102.00'><img src='/new/images/SituAware.png'></a></td></tr>\n";
        print "<tr><td align='left'><br>SPC Situational Awareness <a href='/exper/situation/?lat=32.00&lon=-102.00'>monitor</a>.</td></tr>\n";
        print "</table></td>\n";
}
if (($tornSize == 0) && ($windSize == 0) && ($hailSize == 0)) {
	...
	//If reports, plot report trend UM.
        ...
        print "<tr><td align='center'>\n";
        include("../ReportPlot/reportPlot_sm.php");
        print "</td></tr>\n";
...
?>
	...
	<table summary="layout" border="0">
	 <tr><td id='HighlightTitle'>Public Awareness</td></tr>
          <tr><td align="center"><a href="http://www.nws.noaa.gov/cgi-bin/nwsexit.pl?url=http://www.youtube.com/watch?v=x3V3HZBs1Y4" target="YouTube Clip"><img src="/new/images/WatchvWarn.png"/></a></td></tr>
	...
	<table summary="layout" border="0">
          ...
          <tr><td align="center"><a href="/exper/sseo/" target="_blank"><img src="/new/images/sseo_sm.png" /></a></td></tr>
        </table>
      </td>
...
if (($tornSize == 0) && ($windSize == 0) && ($hailSize == 0)) {
	...
	print "<td valign='top' width='33%' id='TopicContainer'>\n";
        ...
        print "<tr><td align='center'><a href='/exper/sref/' target='_blank'><img src='/new/images/sref_sm.png' /></a></td></tr>\n";
        print "</table></td>\n";
} else {
...
?>
	...
	<table summary="layout" border="0">
	<tr><td id="HighlightTitle">Public Awareness</td></tr>
          <tr><td align="center"><a href="/faq/tornado/#Safety"><img src="/new/images/TorSafety2.png"></a></td></tr>
...
if (($tornSize == 0) && ($windSize == 0) && ($hailSize == 0)) {
	...
	print "<table summary='layout' border='0'>\n";
        ...
        print "<tr><td align='center'><a href='/wcm/#torgraph' target='_blank'><img src='/new/images/2013_torTrends_sm.png' /></a></td></tr>\n";
...
?>
	...
	<div id="HighlightTitle">Latest SPC Publications</div>
        <?php include("../SPCResearch/research.html"); ?>
        </td>
        <td valign="top" width="33%" id="TopicContainer">  
	<div id="HighlightTitle">Latest SPC Case Archive</div>
        <?php include("../SPCCaseArchive/casestudy.html"); ?>
        </td>
       </tr>
